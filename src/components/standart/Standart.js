...
{/* <div className={styles.title__main__inner}>
                <div className={styles.navigation}>
                    {location.pathname === '/MainBlock/Service' ? (
                        <div className={styles.site__navigation}>
                        <Link className={styles.main__link__navigation} to="/MainBlock">
                            Главная
                        </Link>
                        <Link className={styles.main__link__navigation} to="/MainBlock/Service">
                            Услуги
                        </Link>{' '}
                        / Стандарт
                        </div>
                ...
                <div className={styles.title__main__title}>Услуга Стандарт</div>
            </div> */}